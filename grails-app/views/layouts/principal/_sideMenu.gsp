				...
				<div class="nav-collapse sidebar-nav">
					<div class="nav nav-tabs nav-stacked main-menu">
						<sec:ifAllGranted roles="ROLE_ADMIN">
						    <li><a href="${createLink(controller:'group' , action: 'index')}"><i class="fa fa-user"></i><span class="hidden-tablet">Grupos</span></a></li>
                        </sec:ifAllGranted>
                        <li><a href="${createLink(controller:'user' , action: 'index')}"><i class="fa fa-users"></i><span class="hidden-tablet"> Grupos</span></a></li>
