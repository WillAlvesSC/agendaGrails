...
<div class="row-fluid sortable ui-sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <g:form action="updateGroup" controller="group" class="form-horizontal">
                <fieldset>
                    <div class="control-group">
                        <label for="name" class="control-label">Nome do Grupo</label>
                        <div class="controls">
                            <input value="${group.name}" type="text" placeholder="Digite o nome do Grupo" id="name" name="name" class="input-xlarge focused" required>
                        </div>
                    </div>
                    <input  type="hidden" value="${group.id}" name="idGroup">
